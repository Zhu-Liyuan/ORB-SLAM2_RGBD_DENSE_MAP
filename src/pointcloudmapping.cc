...
{
    //pcl::visualization::CloudViewer viewer("viewer");//被注释掉的pcl_viewer
    while(1)
    {
        ...
        for ( size_t i=lastKeyframeSize; i<N ; i++ )
        {
            ...
            pcl::transformPointCloud( *p, *p, trans);
        ...
        // PointCloud::Ptr tmp123=getGlobalMap();//本来的
        // viewer.showCloud(tmp123 );//还原这个
...
{
	pcl::io::savePCDFile( "/home/lenovo/PACKAGES/ORB-SLAM2_RGBD_DENSE_MAP/result.pcd", *globalMap );
...
{    
    ...
    cout<<"globalMap get finished"<<endl;
